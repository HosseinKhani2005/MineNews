          ...
          <div className="lg:hidden mb-6">
            <div className="flex items-center justify-between rounded-2xl p-4 border border-gray-200 dark:border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">پنل کاربری</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">حسین عزیز</p>
                </div>
              </div>
              ...
              {isMobileMenuOpen && (
                ...
                >
                  <nav className="p-3 space-y-2">
                    ...
                    <button
                      onClick={handleToggleTheme}
                      className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition"
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <h2 className="text-xl font-black text-white">حسین</h2>
                          </div>
                        </div>
                  ...
                  <div className="p-4 border-t border-gray-200 dark:border-gray-800 mt-auto">
                    <div className="bg-linear-to-r from-emerald-50 to-cyan-50 dark:from-emerald-950/20 dark:to-cyan-950/20 rounded-2xl p-4 border border-emerald-200 dark:border-emerald-800">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-xs font-bold text-gray-900 dark:text-white">پشتیبانی VIP</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">۲۴ ساعته</p>
                        </div>
                      </div>
                      <Link
                        href="/dashboard/support"
